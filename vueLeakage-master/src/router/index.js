  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        {
          path: '/system/limits',
          component: (resolve) => require(['@/page/system/limits'], resolve),
          redirect: '/system/limits/depart',
          children: [
        ...
        {
          path: '/system/sconfig',
          component: (resolve) => require(['@/page/system/sconfig'], resolve),
          redirect: '/system/sconfig/record',
          children: [
        ...
        {
          path: '/system/log',
          component: (resolve) => require(['@/page/system/log'], resolve)
        },
      ]
    },
